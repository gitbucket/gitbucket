...
trait IndexControllerBase extends ControllerBase {
  ...
  before() {
    ...
    response.addHeader("Content-Security-Policy", "default-src \'self\'; script-src \'self\' \'unsafe-inline\'; connect-src \'self\'; font-src \'self\' https://fonts.gstatic.com; img-src \'self\' data: www.gravatar.com *.modeler.gy; style-src \'self\' \'unsafe-inline\' https://fonts.googleapis.com ;")
