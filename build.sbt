...
libraryDependencies ++= Seq(
  ...
  "io.github.gitbucket"             %  "markedj"                           % "1.0.11",
  ...
  "org.webjars"                     %  "dropzone"                          % "4.3.0-2" exclude("org.webjars","jquery"),
  ...
  "org.webjars.bower"               %  "bootstrap-colorpicker"             % "2.4.0"   exclude("org.webjars.bower","jquery"),
  "org.webjars.bower"               %  "eonasdan-bootstrap-datetimepicker" % "4.17.47" exclude("org.webjars.bower","jquery"),
  "org.webjars.bower"               %  "jquery-textcomplete"               % "1.8.0"   exclude("org.webjars.bower","jquery"),
